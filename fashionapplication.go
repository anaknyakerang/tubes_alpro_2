...
// hapus data sebelum
func clearScreen() {
	/* \033[2J perintah untuk menghapus seluruh teks yang ada di layar terminal saat ini.
	\033[H perintah untuk memindahkan posisi kursor ketikan kembali ke pojok kiri paling atas layar.*/
